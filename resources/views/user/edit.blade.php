        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('user.update', $user->id) }}" method="POST">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" name="name" value="{{ old('name') ?? $user->name }}" placeholder="Имя"/>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="surname" value="{{ old('surname') ?? $user->surname }}" placeholder="Фамилия"/>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" name="patronymic" value="{{ old('patronymic') ?? $user->patronymic }}" placeholder="Отчество"/>
                </div>
                <div class="form-group">
