                             ...
                             <ul class="page-dropdown-menu">
                                 ...
                                 <li class="dropdown-list menu-closer-item">
                                     <a @click.prevent="getCart();getTotalCart()" href="#0" class="number cart-icon">  
                                         <i class="flaticon-shopping-cart"></i>
                                         <span class="description-list">Кошик</span>
                                 ...
                                 <div class="col-12">
                                     <div class="some-info">
                                         <p class="d-flex align-items-center"> <span class="icon"> <i
                                                     class="flaticon-power"></i> </span> Вітаємо в інтернет – магазині Clothing Store</p>
                                         ...
                                         <div class=" d-flex align-items-center justify-content-between ">
                                             <nav class="w-100">
                                                 <ul class="page-dropdown-menu d-flex align-items-center justify-content-center">
                                                     ...
                                                     <li class="dropdown-list w-100">  
                                                         <div class="search-box menu d-flex align-items-center justify-content-center w-75" style="padding:10px 10px 10px 0">  
                                                             <input type="text" v-model="searchValue" class="form-control w-100"
                                                                 placeholder="Знайти товари">
             ...
             <div class="container">
                 <div class="footer_bottom_content">
                     <div class="copyright wow fadeInUp animated">
                         <p>© 2023 <router-link to="/">Clothing Store</router-link></p>
                     </div>
