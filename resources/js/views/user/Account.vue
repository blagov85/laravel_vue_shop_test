                            ...
                            <div class="tab-pane fade" id="v-pills-orders" role="tabpanel"
                                ...
                                <div class="tabs-content__single">
                                    <div class="col-xl-12 wow fadeInUp animated">
                                        <div v-if="orders.length > 0" class="wishlist-table-box">
                                                        ...
                                                        <tr v-for="order in orders" v-bind:key="order.id">
                                                            <td style="width:25%">  
                                                                ...
                                                                <div :id="`popupOrder${order.id}`" class="product-gird__quick-view-popup mfp-hide">
                                                                    <div v-if="popupOrder" class="container">
                                                                        <div class="row justify-content-between align-items-center">
                                                                            
                                                                                <div class="header">
                                                                                    <h5>Замовлення <span>#{{ popupOrder.id }}</span></h5>
                                                                                </div>
                                                                                <div class="header-table">Інформація про замовлення</div>
                                                                                <table class="info-order-table">
                                                                                    <tr>
                                                                                        <td class="head">Дата</td>
                                                                                        <td>{{ popupOrder.date_create }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Прізвище</td>
                                                                                        <td>{{ popupOrder.surname }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Ім'я</td>
                                                                                        <td>{{ popupOrder.name }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Телефон</td>
                                                                                        <td>{{ popupOrder.phone }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Email</td>
                                                                                        <td>{{ popupOrder.email }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Область</td>
                                                                                        <td>{{ popupOrder.region }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Місто</td>
                                                                                        <td>{{ popupOrder.settlement }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Оплата</td>
                                                                                        <td>{{ popupOrder.payment }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Служба доставки</td>
                                                                                        <td>{{ popupOrder.delivery_company }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Відділення</td>
                                                                                        <td>{{ popupOrder.department_DC }}</td>
                                                                                    </tr>
                                                                                </table>
                                                                                <table class="order-table">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr v-for="product in popupOrder.products" :key="product.id">
                                                                                            <td width="10%">
                                                                                ...
                                                                                <table class="sum-order-table">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td class="info">{{ popupOrder.total_price }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Доставка</td>
                                                                                        <td class="info">{{ popupOrder.delivery_cost }}</td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td class="head">Загальна сума</td>
                                                                                        <td class="info">{{ popupOrder.total_price + popupOrder.delivery_cost }}</td>
                                                                                    </tr>
                                                                                </table>
